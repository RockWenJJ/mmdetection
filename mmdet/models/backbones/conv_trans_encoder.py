...
class ConvBlock(BaseModule):
    '''A simple conv block with Two CIR/CBR layers'''
    def __init__(self,
                 in_ch,
                 out_ch,
                 kernel_size,
        ...
        layers.append(build_layer(layer_cfg))
...
class ConvTransformerEncoder(BaseModule):
    """ Conv-Transformer Encoder that utilizes both transformer and CNN features
    ...
    def __init__(self,
        ...
        self.num_features = [int(embed_dims * 2 * 2**i) for i in range(num_layers)]
    ...
    def forward(self, x, pos_embed=None):
        ...
        for i, stage in enumerate(self.stages):
            ...
            x = x_cnn_view + x_trans    # cnn-trans modulation
