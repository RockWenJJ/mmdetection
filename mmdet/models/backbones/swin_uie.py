...
class SwinUIE(BaseModule):
    """ Swin Transformer for underwater image enhancement
    ...
    def __init__(self,
        ...
        # for preprocessing
        self.in_norm = nn.InstanceNorm2d(in_channels)
        ...
        self.patch_embed = PatchEmbed(
            in_channels=in_channels*4, # after pixel unshuffle
            embed_dims=embed_dims,
            conv_type='Conv2d',
