...
# credit: https://github.com/VITA-Group/All-In-One-Underwater-Image-Enhancement-using-Domain-Adversarial-Learning
...
class SyreaNet(BaseModule):
    def __init__(self, **kwargs):
        super(SyreaNet, self).__init__()
        self.wave_encoder = WaveEncoder()
        self.wave_decoder = WaveDecoder()
        self.decoder_b = WaveDecoder(option_unpool='cat3')
        self.decoder_t = WaveDecoder(option_unpool='cat3')
