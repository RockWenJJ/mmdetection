...
class DualDownsample(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.down2 = nn.Sequential(
            nn.PixelUnshuffle(2),
            nn.ReflectionPad2d(1),
            nn.Conv2d(in_channel * 4, out_channel // 2, kernel_size=3, stride=1, padding=0),
            nn.InstanceNorm2d(out_channel//2)
        )
...
class LeWinTransformerBlock(nn.Module):
    def __init__(self, dim, num_heads, win_size=7, shift_size=0,
...
class WaTrV4(BaseModule):
    def __init__(self,
                 in_chans=3,
                 embed_dim=32,
                 depths=[1, 2, 2, 2, 4, 2, 2, 2, 1],
                 num_heads=[2, 4, 4, 8, 16, 8, 8, 4, 2],
                 win_size=7,
                 mlp_ratio=2.,
                 qkv_bias=True,
                 qk_scale=None,
                 ...
                 token_mlp='gdff',
                 dowsample=DualDownsample,
                 upsample=DualUpsample,
                 shift_flag=True,
                 modulator=False,
                 connect=False,
                 **kwargs):
        ...
        self.encoderlayer_2 = BasicLayer(dim=embed_dim * 4,
        ...
        self.encoderlayer_3 = BasicLayer(dim=embed_dim * 8,
        ...
        # Bottleneck
        self.conv = BasicLayer(dim=embed_dim * 16,
        ...
        self.decoderlayer_0 = BasicLayer(dim=embed_dim * 16,
                                                output_dim=embed_dim * 16,
                                                depth=depths[5],
        ...
        self.decoderlayer_1 = BasicLayer(dim=embed_dim * 8,
                                                output_dim=embed_dim * 8,
                                                depth=depths[6],
        ...
        self.decoderlayer_2 = BasicLayer(dim=embed_dim * 4,
                                                output_dim=embed_dim * 4,
                                                depth=depths[7],
        ...
        self.decoderlayer_3 = BasicLayer(dim=embed_dim * 2,
                                                output_dim=embed_dim * 2,
                                                depth=depths[8],
